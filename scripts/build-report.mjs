...
export function buildFinalReport(input) {
  return [
    ...
    "",
    "已验证修复的问题：",
    formatList(input.verifiedRepaired ?? [], "- None"),
    "",
    "待验证修复声明：",
    formatList(input.unverifiedRepairClaims ?? input.repairedIssues ?? [], "- None"),
    "",
    "待外部修复的问题：",
    formatList(input.pendingAutoFix ?? [], "- None"),
    "",
    "需人工确认的问题：",
    formatList(input.manualReview ?? [], "- None"),
    "",
    "复验结果：",
